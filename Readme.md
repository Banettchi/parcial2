...
Primero toca crear 3 instancias EC2 con Amazon Linux y abrir el puerto 8080 en los security groups de las tres. Despues toca instalar java en cada instancia, copiar el jar del math service a las dos instancias que vamos a usar para ese servicio y correrlo en cada una. Para el proxy toca configurar las variables de entorno con las ips de los dos math services que ya quedaron corriendo, eso es pa que el proxy sepa a donde mandar las solicitudes sin tener que tocar el codigo. Despues se copia el jar del proxy a la tercera instancia y se corre. Para probarlo toca abrir el browser con la ip de la instancia del proxy en el puerto 8080. 
